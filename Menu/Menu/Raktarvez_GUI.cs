...
namespace Menu
{
    public partial class Raktarvez_GUI : Form
    {
        ...
        private void HianyzoAlkatresz(object sender, EventArgs e)
        {
            this.Hide();
            HianyzoAlkatresz hinyzo_alkatresz_add = new HianyzoAlkatresz();
            hinyzo_alkatresz_add.Show();
            hinyzo_alkatresz_add.FormClosed += sub_form_closeing;
        }
    }
}
